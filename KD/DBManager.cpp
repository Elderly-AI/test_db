...
void DBManager::save_container(BaseContainer *container){
    ...
    save_doc.append(
        bsoncxx::builder::basic::kvp("$set", 
            [&container](bsoncxx::builder::basic::sub_document sub_doc_1){
                sub_doc_1.append(
                    bsoncxx::builder::basic::kvp("container",
                        [&container](bsoncxx::builder::basic::sub_document sub_doc_2){
                            container->save(sub_doc_2);
                        }
                    )
                );
            }
    ...
    bsoncxx::stdx::optional<bsoncxx::document::value> found_container = collection.find_one(
        bsoncxx::builder::basic::make_document(
            bsoncxx::builder::basic::kvp(
                "_id", bsoncxx::oid{bsoncxx::stdx::string_view{container->id}}
            )
        )
    );
